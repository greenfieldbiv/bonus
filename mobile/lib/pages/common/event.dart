                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: ListView(scrollDirection: Axis.horizontal, children: [
                                  ...
                                  children: <Widget>[
                                    ...
                                    Positioned(
                                        ...
                                        child: Text(
                                          ...
                                          style: GoogleFonts.lato(
                                              color: Colors.blue[700], fontSize: 13, letterSpacing: 1, fontWeight: FontWeight.normal),
                                        )),
                                    Positioned(
                                        top: 220,
                                        left: 25,
                                    ...
                                    Positioned(
                                        ...
                                        child: Text(
                                          'at Sudney, Australia',
                                          style:
                                              GoogleFonts.lato(color: Colors.black54, fontSize: 13, letterSpacing: 1, fontWeight: FontWeight.normal),
                                        )),
                                    Positioned(
                                      top: 246,
                                      child: Padding(
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                                ...
                                                child: Text(
                                                  ...
                                                  style: GoogleFonts.lato(
                                                      color: Colors.grey[500], fontSize: 14, letterSpacing: 1, fontWeight: FontWeight.bold),
                                                )),
                                          ],
                                        ),
                                      ),
                      ...
                      Padding(
                        padding: const EdgeInsets.only(left: 0.0, right: 28, top: 14, bottom: 5),
                        child: Material(
                          borderRadius: BorderRadius.only(topLeft: Radius.circular(10.0), topRight: Radius.circular(10.0)),
                          elevation: 2,
                          child: Column(
