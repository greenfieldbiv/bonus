        ...
        child: Column(
          ...
          children: [
            ...
            Column(
              ...
              children: [
                Padding(
                  ...
                  child: Text(
                    'В сети',
                    style: GoogleFonts.lato(color: Colors.grey[700], fontSize: 20, letterSpacing: 1, fontWeight: FontWeight.bold),
                  ),
                ),
                Padding(
                  padding: const EdgeInsets.only(
              ...
              child: Padding(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintStyle: GoogleFonts.lato(color: Colors.grey[600], fontSize: 15, fontWeight: FontWeight.normal),
                    filled: true,
              ...
              child: ListView(
                ...
                children: [
                  Padding(
                    ...
                    child: Container(
                      decoration: BoxDecoration(border: Border.all(color: Colors.grey[400], width: 2), borderRadius: BorderRadius.circular(10)),
                      child: Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Text(
                          '#Socio',
                          style: GoogleFonts.lato(color: Colors.grey[700], fontSize: 14, letterSpacing: 1, fontWeight: FontWeight.bold),
                        ),
                      ),
                    ),
                  ),
            ...
            Padding(
              ...
              child: Text(
                'A',
                style: GoogleFonts.lato(color: Colors.grey[700], fontSize: 15, letterSpacing: 1, fontWeight: FontWeight.bold),
              ),
            ),
            SizedBox(
              height: 10,
            ...
            InkWell(
              ...
              child: ListTile(
                ...
                subtitle: Text(
                  ...
                  style: GoogleFonts.lato(color: Colors.grey[500], fontSize: 15, letterSpacing: 1, fontWeight: FontWeight.normal),
                ),
              ),
            ),
            ListTile(
